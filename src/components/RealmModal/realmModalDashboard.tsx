...
interface RealmModalDashboardProps {
  handleClose: (event: React.MouseEvent<HTMLElement>) => void
}

const RealmModalDashboard = ({ handleClose }: RealmModalDashboardProps) => {
  return (
    <div id='full-modal' className='flex gap-2'>
      <div
      ...
      <div id='cross'>
        <button onClick={handleClose}>
          <Image src={cross} alt='cross' height={27} width={27} />
        </button>
      </div>
    </div>
  )
...
export default RealmModalDashboard
